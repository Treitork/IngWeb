	...
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">
				Contacta <small>servicio 24/7</small>
			</h1>
			<ol class="breadcrumb">
		...
		<div class="col-md-8">
			...
			<script>
				...
				function init() {
					...
					var locations = [ [ 'Universidad Complutense',
							'Estamos aquí', 'undefined', 'saguila@ucm.es',
							'undefined', 40.45318787386998, -3.73357205026241,
...
.gm-style-iw a {
	color: #4272db;
		...
		<div class="col-md-4">
			...
			<p>
				Calle del Prof. José García Santesmases, 9 <br>Madrid, CP:
				28040<br>
			</p>
			<p>
				<i class="fa fa-phone"></i> <abbr title="Phone">Tlf</abbr>:
				913947501
			</p>
			<p>
				<i class="fa fa-envelope-o"></i> <abbr title="Email">Mail</abbr>: <a
					href="mailto::prueba@asd.com">Omniscracia@ucm.es</a>
			</p>
			<p>
				<i class="fa fa-clock-o"></i> <abbr title="Hours">Hro</abbr>: Lunes
				- Viernes: 9:00 AM to 1:00 PM
			</p>
	...
	<div class="row">
		<div class="col-md-8">
			...
			<form name="sentMessage" id="contactForm" novalidate>
				...
				<div class="control-group form-group">
					<div class="controls">
						<label>Teléfono de contacto:</label> <input type="tel"
				...
				<div class="control-group form-group">
					<div class="controls">
						<label>Dirección Email:</label> <input type="email"
