...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-md-4">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h4>
						<i class="fa fa-fw fa-check"></i> Buen diseño, mejor
						funcionamiento
					</h4>
				</div>
				<div class="panel-body">
					<p>Ese es nuestro lema en el equipo de desarrollo de
						Omniscracia. Gracias a la reutilización de software libre y
		...
		<div class="col-md-4">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<p>Podrás registrarte rellenando un simple formulario, con un
						correo institucional rellenando nuestro formulario en menos de ¡1
						minuto!.¡Es totalmente gratuito!, ¿a qué esperas para entrar?</p>
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<p>Una nueva forma de interactuar entre docentes y alumnos
						nunca antes vista. Comparte opiniones con un solo clic de ratón de
	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<p>Tu opinión tendrá tanta importancia como nunca antes.
				...
				terminaban en la papelera. Además, no son solo los alumnos los que
				deberían evaluar al profesor, si no que el profesor también debería
				...
				quedaban relegadas al olvido, excesiva falta de comunicación entre
				alumno y profesor, sugerencias por parte del profesorado sugiriendo
				valoración hacia sus alumnos... y por muchos otros motivos surge
				Omniscracia. Una nueva forma de valorar criterios no académicos
				entre alumnos y profesores que no dejará a nadie indiferente. Tu
				opinion tendrá una influencia directa nunca vista anteriormente, ¿a
				qué esperas para unirte?</p>
		</div>
		<div class="col-md-6">
	...
	<div class="well">
		<div class="row">
			<div class="col-md-8">
				<p>Después de todo... ¿tienes alguna duda?,¿alguna
					sugerencia?,¿alguna observación?. ¡No te las guardes, contacta con
					nosotros!</p>
			</div>
			<div class="col-md-4">
